...
const AUTO_SAVE_EVENTS = new Set([
  ...
  EditorEventType.SLIDE.UPDATE_BACKGROUND_IMAGE,
  EditorEventType.SLIDE.UPDATE_BACKGROUND_IMAGE_POSITION,
  EditorEventType.SLIDE.UPDATE_BACKGROUND_IMAGE_SCALE,
