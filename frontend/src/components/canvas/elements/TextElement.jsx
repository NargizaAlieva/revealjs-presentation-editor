...
import useTextLayout from "./text/hooks/useTextLayout";
import useTextOverflow from "./text/hooks/useTextOverflow";
...
export default function TextElement({
  ...
  const { paragraphTops, editableOffsetTop } = useTextLayout({
    editableRef,
    innerHTML,
